...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('office_task', 'worker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('office_task', 'worker_id')
