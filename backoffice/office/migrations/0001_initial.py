...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MessageFolder'
        db.create_table('office_messagefolder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('office', ['MessageFolder'])

        # Adding model 'Message'
        db.create_table('office_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_from_message', to=orm['auth.User'])),
            ('user_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_to_message', to=orm['auth.User'])),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['office.MessageFolder'])),
        ...
        db.send_create_signal('office', ['Message'])


    def backwards(self, orm):
        
        # Deleting model 'MessageFolder'
        db.delete_table('office_messagefolder')

        # Deleting model 'Message'
        db.delete_table('office_message')
