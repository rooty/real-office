...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('office_task', 'description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.description'
        db.delete_column('office_task', 'description')
    ...
    models = {
        ...
        'office.task': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 18, 3, 8, 47, 938090)'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
