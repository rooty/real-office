...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Message.folder'
        db.delete_column('office_message', 'folder_id')


    def backwards(self, orm):
        
        # Adding field 'Message.folder'
        db.add_column('office_message', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['office.MessageFolder']), keep_default=False)
