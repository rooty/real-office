...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.terminate'
        db.add_column('office_task', 'terminate', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Project.percenttask'
        db.add_column('office_project', 'percenttask', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.terminate'
        db.delete_column('office_task', 'terminate')

        # Deleting field 'Project.percenttask'
        db.delete_column('office_project', 'percenttask')
