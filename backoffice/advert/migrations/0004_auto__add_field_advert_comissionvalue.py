...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advert.comissionvalue'
        db.add_column('advert_advert', 'comissionvalue', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Advert.comissionvalue'
        db.delete_column('advert_advert', 'comissionvalue')
