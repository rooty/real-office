...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TermAccommodation.days'
        db.add_column('advert_termaccommodation', 'days', self.gf('django.db.models.fields.IntegerField')(default=datetime.date(2012, 2, 18), max_length=3), keep_default=False)

        # Adding field 'ArendaBusinessPeriod.period'
        db.add_column('advert_arendabusinessperiod', 'period', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=3), keep_default=False)

        # Deleting field 'Photo.title'
        db.delete_column('advert_photo', 'title')

        # Deleting field 'Photo.created'
        db.delete_column('advert_photo', 'created')

        # Adding field 'Photo.advert'
        db.add_column('advert_photo', 'advert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advert.Advert'], null=True, blank=True), keep_default=False)

        # Adding field 'DopOptions.realtype'
        db.add_column('advert_dopoptions', 'realtype', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['advert.RealType2']), keep_default=False)

        # Adding field 'AdvOptions.realtype'
        db.add_column('advert_advoptions', 'realtype', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['advert.RealType2']), keep_default=False)

        # Adding field 'Advert.flattypeid'
        db.add_column('advert_advert', 'flattypeid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advert.FlatType'], null=True), keep_default=False)

        # Adding field 'Advert.video'
        db.add_column('advert_advert', 'video', self.gf('django.db.models.fields.files.FileField')(default=0, max_length=512, blank=True), keep_default=False)

        # Removing M2M table for field photos on 'Advert'
        db.delete_table('advert_advert_photos')

        # Changing field 'Advert.square'
        db.alter_column('advert_advert', 'square', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'Advert.usercostforall'
        db.alter_column('advert_advert', 'usercostforall', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=0))

        # Changing field 'Advert.housetype'
        db.alter_column('advert_advert', 'housetype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advert.HouseType'], null=True))

        # Changing field 'Advert.squarelife'
        db.alter_column('advert_advert', 'squarelife', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'Advert.kitchen'
        db.alter_column('advert_advert', 'kitchen', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'Advert.costforall'
        db.alter_column('advert_advert', 'costforall', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=0))

        # Adding field 'UserCart.session_key'
        db.add_column('advert_usercart', 'session_key', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'UserCart.user'
        db.alter_column('advert_usercart', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'TermAccommodation.days'
        db.delete_column('advert_termaccommodation', 'days')

        # Deleting field 'ArendaBusinessPeriod.period'
        db.delete_column('advert_arendabusinessperiod', 'period')

        # Adding field 'Photo.title'
        db.add_column('advert_photo', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Photo.created'
        db.add_column('advert_photo', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2012, 2, 18), blank=True), keep_default=False)

        # Deleting field 'Photo.advert'
        db.delete_column('advert_photo', 'advert_id')

        # Deleting field 'DopOptions.realtype'
        db.delete_column('advert_dopoptions', 'realtype_id')

        # Deleting field 'AdvOptions.realtype'
        db.delete_column('advert_advoptions', 'realtype_id')

        # Deleting field 'Advert.flattypeid'
        db.delete_column('advert_advert', 'flattypeid_id')

        # Deleting field 'Advert.video'
        db.delete_column('advert_advert', 'video')
        ...
        # Changing field 'Advert.square'
        db.alter_column('advert_advert', 'square', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Advert.usercostforall'
        db.alter_column('advert_advert', 'usercostforall', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'Advert.housetype'
        db.alter_column('advert_advert', 'housetype_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['advert.HouseType']))

        # Changing field 'Advert.squarelife'
        db.alter_column('advert_advert', 'squarelife', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Advert.kitchen'
        db.alter_column('advert_advert', 'kitchen', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Advert.costforall'
        db.alter_column('advert_advert', 'costforall', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Deleting field 'UserCart.session_key'
        db.delete_column('advert_usercart', 'session_key')

        # Changing field 'UserCart.user'
        db.alter_column('advert_usercart', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
    ...
    models = {
        ...
        'advert.photo': {
            ...
            'advert': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['advert.Advert']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'advert.usercart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_key': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
