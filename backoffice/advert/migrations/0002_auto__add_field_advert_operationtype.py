...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advert.operationtype'
        db.add_column('advert_advert', 'operationtype', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['advert.OperationType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Advert.operationtype'
        db.delete_column('advert_advert', 'operationtype_id')
